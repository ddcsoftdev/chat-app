package old.conversation.infrastructure.entity;
...
public class ConversationEntity extends AbstractAuditingEntity<Long> {
    ...
    private Set<UserOldEntity> users = new HashSet<>();

    public ConversationEntity(Long id, UUID publicId, String name, Set<MessageEntity> messages, Set<UserOldEntity> users) {
        this.id = id;
    ...
    public static ConversationEntity from(Conversation conversation) {
        ...
        conversationEntityBuilder.users(UserOldEntity.from(conversation.getMembers().stream().toList()));
    ...
    public static Conversation toDomain(ConversationEntity conversation) {
        ConversationBuilder conversationEntityBuilder = ConversationBuilder
                ...
                .members(UserOldEntity.toDomain(conversation.getUsers()))
    ...
    public Set<UserOldEntity> getUsers() {
        return users;
    }
    ...
    public void setUsers(Set<UserOldEntity> users) {
        this.users = users;
    }
