package old.message.infrastructure.entity;
...
import com.chatapp.message.infrastructure.entity.MessageEntityBuilder;
...
public class MessageEntity extends AbstractAuditingEntity<Long> {
    ...
    public MessageEntity(Long id, UUID publicId, Instant sendTime, String text, MessageType type,
                         MessageSendState sendState, UserOldEntity sender, ConversationEntity conversation, MessageContentBinaryEntity contentBinary) {
        this.id = id;
    ...
    public static MessageEntity from(Message message) {
        ...
        UserOldEntity user = UserOldEntityBuilder.userOldEntity()
    ...
    public UserOldEntity getSender() {
        return sender;
    }

    public void setSender(UserOldEntity sender) {
        this.sender = sender;
    }
