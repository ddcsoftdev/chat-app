import { Component, ElementRef, inject, PLATFORM_ID, ViewChild, AfterViewInit, OnInit, OnDestroy } from '@angular/core';
...
export class ChatWindowComponent implements OnInit, AfterViewInit, OnDestroy {
 ...
 getUserInitial(userId: number): string {
   ...
   const user = Array.from(this.currentConversation.users)
     .find((u: UserModelNoConversation) => u.id === userId);
 ...
 getConversationTitle(): string {
   ...
   return Array.from(this.currentConversation.users)
